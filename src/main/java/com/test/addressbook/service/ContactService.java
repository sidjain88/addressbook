...
public class ContactService {
    ...
    public void compareAddressBook(String commaSeparatedNames) {
    	...
    	List<String> result = Stream.concat(nameList1.stream(), nameList2.stream()).distinct().filter(name -> !nameList1.contains(name) || !nameList2.contains(name)).collect(Collectors.toList());
